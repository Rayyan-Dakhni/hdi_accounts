...
const InfoAlert = (props) => {
  ...
  return (
    <div
      id={props.id}
      className='absolute top-5 right-5 w-72 h-auto p-5 rounded-md shadow-md bg-gradient-to-r from-orange-700 via-gray-900 to-gray-900 transition-all duration-500 transform -translate-y-5 opacity-0 invisible'
    >
